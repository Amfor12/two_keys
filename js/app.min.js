...
let _slideDown = (target, duration = 900, showmore = 0) => {
  if (!target.classList.contains("_slide")) {
    target.classList.add("_slide");
    target.hidden = target.hidden ? false : null;

    // Сбрасываем ширину, если showmore задан
    ...
    // Запуск принудительного пересчета layout
    target.offsetWidth;
    ...
    // Сброс временных стилей после анимации
    window.setTimeout(() => {
    ...
    if (tabsContent.length > 0) {
      tabsContent.forEach((tabsContentItem, index) => {
        if (tabsTitles[index].classList.contains("_tab-active")) {
          ...
          // Добавляем класс активности к tabs__body
          tabsContentItem.classList.add("_tab-body-active");
        } else {
          if (tabsBlockAnimate) {
          ...
          tabsContentItem.classList.remove("_tab-body-active");
        }
      });
    }
  }
...
function menuInit() {
  ...
  document.addEventListener("click", function (event) {
    var menuOpen = document.documentElement.classList.contains("menu-open");
    var menuBody = document.querySelector(".menu__body");

    // Проверяем, был ли клик вне элемента .menu__body и меню открыто
    if (!menuBody.contains(event.target) && menuOpen && !iconMenu.contains(event.target)) {
      functions_menuClose(); // Закрываем меню
    }
  });
}
function menuOpen() {
...
function initSliders() {
  ...
  if (document.querySelector(".hero__slider")) {
    const swiper = new core(".hero__slider", {
      ...
      on: {
        init: function (swiper) {
          updatePagination(swiper); // Передаем swiper как аргумент
        },
    ...
    function updatePagination(swiper) {
      const currentSlide = swiper.realIndex - 3 >= 0 ? swiper.realIndex - 2 : swiper.realIndex + 1; // Учитываем вычитание дубликатов
      const totalSlides = swiper.slides.length - 3; // Вычитаем 3 дубликата из общего числа
      const paginationElement = document.querySelector(".pagination-hero");

      if (paginationElement) {
        paginationElement.textContent = `${currentSlide}/${totalSlides}`;
      }
    }
  }
  if (document.querySelector(".news__slider")) {
    const swiper = new core(".news__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 4500,
        disableOnInteraction: true, // Остановка автоплей при взаимодействии
      },
      slidesPerView: 2,
      spaceBetween: 15,
      autoHeight: false,
      ...
      navigation: {
        nextEl: ".btn-news-next1",
        prevEl: ".btn-news-prev1",
      },
    ...
    // Добавляем обработку событий для остановки/запуска автоплей при наведении
  ...
  if (document.querySelector(".modal-projects__slider")) {
    const swiper = new core(".modal-projects__slider", {
      modules: [Navigation, Pagination],
    ...
    function updatePagination(swiper) {
      const currentSlide = swiper.realIndex + 1; // Текущий слайд (Swiper использует индекс с 0)
      const totalSlides = swiper.slides.length; // Общее количество слайдов
      const paginationElement = document.querySelector(".pagination-modal");
  ...
  if (document.querySelector(".modal-full-slider__slider")) {
    const swiper = new core(".modal-full-slider__slider", {
      modules: [Navigation, Pagination],
    ...
    function updatePagination(swiper) {
      const currentSlide = swiper.realIndex + 1; // Текущий слайд (Swiper использует индекс с 0)
      const totalSlides = swiper.slides.length; // Общее количество слайдов
      const paginationElement = document.querySelector(".paginn");
  ...
  if (document.querySelector(".hot__slider-nav")) {
    const swiper = new core(".hot__slider-nav", {
      modules: [Navigation, Pagination, Autoplay],
  ...
  if (document.querySelector(".baner__slider")) {
    const swiper = new core(".baner__slider", {
      modules: [Navigation, Pagination, Autoplay],
  ...
  if (document.querySelector(".company__slider")) {
    const swiper = new core(".company__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 2500,
  ...
  if (document.querySelector(".stroi__slider")) {
    const swiper = new core(".stroi__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 4500,
        disableOnInteraction: false,
  ...
  if (document.querySelector(".panoram__slider")) {
    const swiper = new core(".panoram__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 9500,
        disableOnInteraction: false,
  ...
  if (document.querySelector(".infra__slider")) {
    const swiper = new core(".infra__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 9500,
        disableOnInteraction: false,
      ...
      navigation: {
        nextEl: ".infra-btn-next",
        prevEl: ".infra-btn-prev",
      },

      on: {},
    });
  }
  if (document.querySelector(".stile__slider")) {
    const swiper = new core(".stile__slider", {
      modules: [Navigation, Pagination, Autoplay],
      autoplay: {
        delay: 9500,
        disableOnInteraction: false,
      ...
      on: {
        slideChange: function () {
          // Получаем изображение первого слайда
          const firstSlideImage = this.slides[0].querySelector("img").src;
          // Обновляем изображение в блоке .zamena-img
          if (document.querySelector(".zamena-img")) {
            document.querySelector(".zamena-img").src = firstSlideImage;
          }
        },
      },
    });
  }
  if (document.querySelector(".park__slider")) {
    const swiper = new core(".park__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // autoplay: {
      //   delay: 90500,
      //   disableOnInteraction: false,
  ...
  if (document.querySelector(".plan__slider")) {
    const swiper = new core(".plan__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // autoplay: {
      //   delay: 90500,
      //   disableOnInteraction: false,
  ...
  if (document.querySelector(".chois__slider")) {
    const swiper = new core(".chois__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // autoplay: {
      //   delay: 90500,
      //   disableOnInteraction: false,
      ...
      navigation: {
        nextEl: ".chois-btn-next",
        prevEl: ".chois-btn-prev",
      },
      breakpoints: {
        320: {
          slidesPerView: 1.15,
  ...
  if (document.querySelector(".komfort__slider")) {
    const swiper = new core(".komfort__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // effect: "fade",
      // autoplay: {
      //   delay: 90500,
      ...
      navigation: {
        nextEl: ".komfort-btn-next",
        prevEl: ".komfort-btn-prev",
      },

      on: {},
    });
  }
  if (document.querySelector(".month__slider")) {
    const swiper = new core(".month__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // autoplay: {
      //   delay: 90500,
      //   disableOnInteraction: false,
  ...
  if (document.querySelector(".hod__slider")) {
    const swiper = new core(".hod__slider", {
      modules: [Navigation, Pagination, Autoplay],
      // autoplay: {
      //   delay: 90500,
      //   disableOnInteraction: false,
...
document.addEventListener("click", function (e) {
  e.preventDefault();
  let tr = e.target;
  if (tr.closest(".custom-select__list li")) {
    let par = tr.closest(".custom-select");
    if (par) {
      let ttl = par.querySelector(".custom-select__title");
      if (ttl) {
        ttl.innerHTML = `
          <span>${tr.innerHTML}</span>
...
if (backToTopButton && footer) {
  const buttonHeight = backToTopButton.offsetHeight; // Высота кнопки

  window.addEventListener("scroll", function () {
    const footerTop = footer.getBoundingClientRect().top; // Верх футера относительно окна
    const buttonBottom = window.innerHeight - buttonHeight; // Нижняя граница кнопки относительно окна

    // Если кнопка не пересекается с футером, показываем её
    if (window.scrollY > 300 && footerTop > buttonBottom) {
      backToTopButton.classList.add("visionn");
    } else {
      // Скрываем кнопку, если она пересекается с футером
      backToTopButton.classList.remove("visionn");
    }
  });
...
document.addEventListener("click", function (e) {
  let tr = e.target;
  // e.preventDefault();
  if (tr.closest(".modal-menu__close")) {
    document.querySelector(".modal-menu").style = "opacity:0;";
  }
  if (tr.closest(".menu__icon")) {
    document.querySelector(".modal-menu").style = "opacity:1;bottom:0;";
  }
  if (tr.closest(".modal-form__close")) {
    document.querySelector(".modal-form").style = "opacity:0;";
  }
  if (
    tr.closest(".header__connection-btn") ||
    tr.closest(".header__connection-btn-mob") ||
    tr.closest(".modal-form-open")
  ) {
    e.preventDefault();
    document.querySelector(".modal-form").style = "opacity:1;right:0;";
  }

  if (tr.closest(".modal-projects-open")) {
    document.body.style = `overflow:hidden`;
    document.querySelector(".modal-projects").style = "opacity:1;bottom:0;";
  }
  if (
    tr.closest(".close-modal-projects") ||
    (tr.closest(".modal-projects") && !tr.closest(".modal-projects__card-box"))
  ) {
    tr.closest(".modal-projects").style = "opacity0;bottom:-200%;";
    document.body.style = ``;
  }
  if (tr.closest(".modal-rieltoram-open")) {
    document.querySelector(".modal-rieltoram").style = "opacity:1;left:0;bottom:0";
  }
  if (tr.closest(".close-modal")) {
    if (tr.closest(".modal-block")) {
      let par = tr.closest(".modal-block");
      par.style = "";
    }
  }
  if (tr.closest(".modal-commerce-open")) {
    document.querySelector(".modal-commerce2").style = "opacity:1;left:0;bottom:0";
  }
  if (tr.closest(".close-modal")) {
    if (tr.closest(".modal-block")) {
      let par = tr.closest(".modal-block");
  ...
  if (tr.closest(".modal-project-open")) {
    document.querySelector(".modal-form-project").style = "opacity:1;left:0;bottom:0";
  }
  if (tr.closest(".modal-novo-open")) {
    console.log("1");
    e.preventDefault();
    document.querySelector(".modal-novo").style = "opacity:1;left:0;bottom:0";
  }
});
document.addEventListener("DOMContentLoaded", function () {
  const navButtons = document.querySelectorAll(".hot__nav-btn");
  const tabContents = document.querySelectorAll(".hot__tabs-body");
  ...
  navButtons.forEach((button) => {
    button.addEventListener("click", function (event) {
      ...
      // Получаем номер таба из data-tab атрибута
      ...
      // Показываем текущее содержимое таба
      const activeTabContent = document.querySelector(`.hot__tabs-body[data-tab-content="${tabNumber}"]`);
      activeTabContent.style.display = "block";
    });
  });
});

function animationLogo(params) {
  const logo = document.querySelector(".logo-animation");
  const logoParent = document.querySelector(".header__logo");
  const background = document.querySelector(".logo-background");

  if (!logo || !logoParent || logo.closest(".wrapper-project")) return;

  // Шаг 1: Позиционирование логотипа по центру экрана
  ...
  // Шаг 2: Увеличиваем логотип в центре экрана
  setTimeout(() => {
    logo.style.transform = "scale(2.5)";
    console.log("Логотип увеличен до 2.5x");
  }, 100);

  // Шаг 3: Возвращаем логотип к обычному размеру по центру
  setTimeout(() => {
    logo.style.transform = "scale(1)";
    console.log("Логотип возвращен к обычному размеру");
  }, 1400);

  setTimeout(() => {
    background.style.opacity = 0;
    console.log("Фон логотипа стал прозрачным");
  }, 1700);
  setTimeout(() => {
    background.style.display = "none";
    const elements = [
      { selector: ".news-card-a-anim", classToAdd: "fade-up" },
      { selector: ".animbaner1", classToAdd: "fade-up2" },
      { selector: ".text-amin", classToAdd: "fade-left2" },
      { selector: ".news-card-c__img", classToAdd: "fade-down" },
    ];
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            observer.unobserve(entry.target); // Отменяем наблюдение после добавления анимации
          }
        });
      },
      { threshold: 0.4 }
    ); // Анимация начнется, когда 10% элемента появится в видимости

    // Проходим по элементам и добавляем наблюдателя для каждого
    elements.forEach(({ selector, classToAdd }) => {
      document.querySelectorAll(selector).forEach((element) => {
        element.dataset.classToAdd = classToAdd; // Сохраняем класс для анимации
        observer.observe(element);
      });
    });
  }, 2000);

  // Шаг 4: Плавно перемещаем логотип на место в шапке
  setTimeout(() => {
    const parentRect = logoParent.getBoundingClientRect();
    console.log(`Координаты родителя: ${JSON.stringify(parentRect)}`);

    // Рассчитываем позицию для перемещения
    if (window.scrollY > 0) {
      const targetTop = parentRect.top; // Возвращаем логотип к верхней части родителя
      const targetLeft = parentRect.left + window.scrollX; // Учитываем прокрутку по горизонтали
      // Перемещаем логотип на место в шапке
      logo.style.top = `${targetTop}px`;
      logo.style.left = `${targetLeft}px`;
      console.log("Логотип перемещен на место в шапке");
    } else {
      const targetTop = parentRect.top + window.scrollY; // Учитываем прокрутку
      const targetLeft = parentRect.left + window.scrollX;
    ...
    // Шаг 5: Меняем позиционирование на статическое
    setTimeout(() => {
      logo.style.position = "static";
      console.log("Позиционирование логотипа изменено на статическое");
    }, 3000);
  }, 1800);
}
...
// });
document.addEventListener("DOMContentLoaded", function () {
  const toggleButton = document.querySelector(".modal-menu__zoe-open-full");

  if (toggleButton) {
    toggleButton.addEventListener("click", function () {
      const menu = document.querySelector(".menu-toggle-modal");
      ...
      if (menu) {
        ...
        if (currentDisplay === "flex") {
          ...
          this.querySelector("p").textContent = "развернуть полное меню";
        } else {
          menu.style.display = "flex";
          this.querySelector("p").textContent = "свернуть полное меню";
        }
      } else {
        console.error("Элемент с классом .menu-toggle-modal не найден.");
      }
    });
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const tabButtons = document.querySelectorAll(".chois__vtn-nav[data-tab]");
  // Находим все элементы с классом ttab
  const tabContents = document.querySelectorAll(".ttab");

  // Проверяем, есть ли табы на странице
  if (tabButtons.length === 0 || tabContents.length === 0) {
    return; // Если табы или контент не найдены, выходим
  }
  ...
  tabButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      // Получаем номер таба из data-атрибута кнопки
      const tabNumber = button.getAttribute("data-tab");

      // Скрываем все табы
      tabContents.forEach((tab) => tab.classList.remove("active"));

      // Показываем нужный таб через селектор атрибута
      const currentTab = document.querySelector(`.ttab${tabNumber}`);
...
document.addEventListener("DOMContentLoaded", function () {
  const sidebar = document.querySelector(".project-wrapper__sidebar");
  const sidebarWrap = document.querySelector(".sidebar-wrap"); // Блок для привязки
  if (sidebar && sidebarWrap) {
    ...
    window.addEventListener("scroll", function () {
      if (window.pageYOffset > offsetTop) {
        ...
        // Учитываем левый край блока sidebarWrap
        const sidebarLeft = sidebarWrap.getBoundingClientRect().left;
        sidebar.style.left = `${sidebarLeft}px`;
      } else {
        sidebar.style.position = "static";
        sidebar.style.left = "auto"; // Сбрасываем значение left
      }
    });
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  // Находим все кнопки с классом 'mont-btn'
  const buttons = document.querySelectorAll(".mont-btn");
  ...
  if (buttons.length > 0) {
    buttons.forEach(function (button) {
      button.addEventListener("click", function () {
        ...
        // Добавляем класс 'active' на текущую нажатую кнопку
        this.classList.add("active");
      });
    });
  }
...
document.addEventListener("DOMContentLoaded", function () {
  // Находим все кнопки с классом 'hod__btn'
  const yearButtons = document.querySelectorAll(".hod__btn");
...
//   if (output) {
//     // Полный текст с HTML-разметкой для финального вывода
//     const finalText = "Строить <span>с&nbsp;чувством</span> и&nbsp;толком";

//     // Разбиваем текст на части по символам с учетом HTML-тегов
//     const textParts = [];
//     finalText.split(/(<[^>]+>|[^<]+)/).forEach((part) => {
//       if (part.startsWith("<span")) {
//         const style = part.match(/<span[^>]*>/)[0];
//         part
//           .replace(/<span[^>]*>(.*?)<\/span>/, "$1")
//           .split("")
//           .forEach((char) => {
//             textParts.push({ char, style });
//           });
//       } else {
...
//     // Печать текста с учетом стилей
//     const animateTitle = () => {
//       let index = 0;
//       const typingInterval = setInterval(() => {
//         if (index < textParts.length) {
//           const { char, style } = textParts[index];
//           output.innerHTML += style ? `${style}${char}</span>` : char;
//           index++;
//         } else {
//           clearInterval(typingInterval);
//           output.innerHTML = finalText; // Восстановление оригинального HTML с тегами
//         }
//       }, 100); // Скорость печати
//     };

//     // Анимация многоточия и задержка
//     let dotCount = 0;
...
//     // Ожидание перед началом печати текста
//     setTimeout(() => {
//       clearInterval(dotInterval);
//       dots.textContent = ""; // Убираем многоточие
//       animateTitle(); // Запускаем печать текста
//     }, 3000);
//   }
// });
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(() => {
    // Задержка запуска анимации на 3 секунды
    const titleElement = document.getElementById("text-output");
    if (!titleElement) return;

    const initialHTML = document.getElementById("hiden-title"); // Оригинальный HTML
    const initialHeight = titleElement.offsetHeight;
    const textParts = [];

    // Разбиваем текст на части и стили
    initialHTML.childNodes.forEach((node) => {
      if (node.nodeType === Node.TEXT_NODE) {
        node.textContent.split("").forEach((char) => {
          textParts.push({ char, style: "" });
        });
      } else if (node.nodeType === Node.ELEMENT_NODE) {
        const style = node.outerHTML.match(/<span[^>]*>/)[0] || "";
        node.textContent.split("").forEach((char) => {
          textParts.push({ char, style });
        });
      }
    ...
    // Задаем начальные размеры
    // titleElement.style.height = `${initialHeight}px`;
    titleElement.innerHTML = ""; // Очищаем текст перед анимацией
    ...
    const animateTitle = () => {
      ...
      const typingInterval = setInterval(() => {
        if (index < textParts.length) {
          const { char, style } = textParts[index];
          titleElement.innerHTML += style ? `${style}${char}</span>` : char;
          index++;
        } else {
          clearInterval(typingInterval);
          titleElement.style.removeProperty("height");
          // titleElement.innerHTML = initialHTML; // Возвращаем оригинальный HTML с тегами
        }
      }, 100); // Скорость печати
    };

    animateTitle(); // Запускаем анимацию для единственного элемента
  }, 3000); // Задержка перед запуском анимации в 3 секунды
});

document.addEventListener("DOMContentLoaded", function () {
  const initialSlides = document.querySelectorAll(".hero .hero__slide");
  if (initialSlides) {
    // Присваиваем класс "initial" только для первых трех слайдов
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  titles.forEach((titleElement) => {
    const initialHTML = titleElement.innerHTML.trim(); // Оригинальный HTML
    const initialHeight = titleElement.offsetHeight;
    const initialWidth = titleElement.offsetWidth;
    const textParts = [];

    // Проходим по узлам и создаем массив с текстовыми узлами и стилями
    titleElement.childNodes.forEach((node) => {
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        const style = node.outerHTML.match(/<span[^>]*>/)[0] || ""; // Получаем начальный тег span
        node.textContent.split("").forEach((char) => {
          textParts.push({ char, style });
        });
      }
    ...
    titleElement.style.height = `${initialHeight}px`;
    // titleElement.style.width = `${initialWidth}px`;
    titleElement.innerHTML = ""; // Очищаем текст перед анимацией
...
document.addEventListener("DOMContentLoaded", function () {
  const elements = document.querySelectorAll(
    ".projects__card-grey-tag, .hot__tabs, .projects__card-top-inf, .projects__card-title, .fade-right"
  );
  ...
  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        if (entry.target.classList.contains("fade-right") || entry.target.classList.contains("hot__tabs")) {
          entry.target.classList.add("fade__right"); // Добавляем fade__right для элементов с fade-right
        }
        entry.target.classList.add("fade-left2"); // Добавляем fade-left2 для всех
  ...
  window.addEventListener("scroll", function () {
    var zakrep = document.getElementById("zakrep");
    if (zakrep) {
      var zakrepotsuda = document.getElementById("zakrepotsuda").getBoundingClientRect();
      var zakrepdosuda = document.getElementById("zakrepdosuda").getBoundingClientRect();
      // Показываем плашку, когда #zakrepotsuda виден и до того, как #zakrepdosuda войдет в экран
      if (zakrepotsuda.bottom <= window.innerHeight && zakrepdosuda.top > window.innerHeight) {
        zakrep.style.display = "flex"; // Показываем плашку
        // zakrep.style.top = zakrepotsuda.bottom + "px"; // Позиционируем плашку прямо после #zakrepotsuda
      } else {
        zakrep.style.display = "none"; // Скрываем плашку
      }
    }
  });
});
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cards = document.querySelectorAll(".baner__card");

  if (!banerRight || cards.length === 0) return;

  const options = {
    threshold: 0.5, // Запуск, когда элемент виден наполовину
  };

  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        // Задержка перед применением анимаций
        setTimeout(() => {
          cards[1].classList.add("fade__right");
          cards[2].classList.add("fade-down");
          cards[3].classList.add("fade-up");
        }, 1000); // Задержка 1000 мс (1 секунда)

        // Останавливаем наблюдение, чтобы анимация не повторялась
        observer.unobserve(banerRight);
      }
    });
  }, options);

  observer.observe(banerRight);
});
...
if (cards.length > 0) {
  ...
  cards.forEach((card) => {
    ...
    if (video) {
      // Проверяем, существует ли видео внутри карточки
      ...
      card.addEventListener("mouseleave", () => {
        video.pause();
        video.currentTime = 0;
        card.querySelector(".bg").style.opacity = "";
      });
    } else {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const elementsToObserve = [
    { element: document.querySelector(".draw-border"), classToAdd: "animate-border anim" },
    { element: document.querySelector(".last-form__right"), classToAdd: "fade-right2" },
    { element: document.querySelector(".hod__actions"), classToAdd: "fade-right2" },
    { element: document.querySelector(".auto__baner"), classToAdd: "fade-left" },
    { element: document.querySelector(".otdelka__right"), classToAdd: "fade__right" },
    { element: document.querySelector(".chois__bottom"), classToAdd: "fade-up" },
    { element: document.querySelector(".chois__top"), classToAdd: "fade-left" },
    { element: document.querySelector(".form-line"), classToAdd: "fade__right" },
    { element: document.querySelector(".footer-form__body"), classToAdd: "fade__right" },
    { element: document.querySelector(".baner__item1"), classToAdd: "animate-borderr" },
    { element: document.querySelector(".baner__item2"), classToAdd: "animate-borderr22" },
    { element: document.querySelector(".baner33"), classToAdd: "animate-borderr" },
    { element: document.querySelector(".baner34"), classToAdd: "animate-borderr22" },
    { element: document.querySelector(".hot__plan"), classToAdd: "animate-border2" },
    { element: document.querySelector(".krug-anim1"), classToAdd: "animate-borderrr" },
    { element: document.querySelector(".krug-anim2"), classToAdd: "animate-borderrr22" },
    { element: document.querySelector(".company__revi-titte"), classToAdd: "animateline" },
    { element: document.querySelector(".park"), classToAdd: "active-line" },
    { element: document.querySelector(".panoram"), classToAdd: "active-line" },
  ];

  elementsToObserve.forEach(({ element, classToAdd }) => {
    if (element) {
      const observer = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              entry.target.classList.add(...classToAdd.split(" ")); // Добавляем все классы
              observer.unobserve(entry.target); // Прекращаем отслеживание для текущего элемента
            }
          });
        },
        { rootMargin: "0px 0px 15% 0px" } // Опция для задержки срабатывания
      );

      observer.observe(element); // Наблюдаем за элементом
    }
  });
});

const lines1 = document.querySelectorAll(".protect__line");
if (lines1.length > 0) {
  let currentIndex = 0;

  function showNextSlide() {
    // Убираем активный класс у текущего элемента
    lines1[currentIndex].classList.remove("active"); // Убираем видимость

    // Переход к следующему элементу (цикл)
    currentIndex = (currentIndex + 1) % lines1.length;

    // Показываем новый элемент
    lines1[currentIndex].classList.add("active"); // Делаем видимым
  }

  // Запускаем функцию показывать следующий слайд каждые 4 секунды
  setInterval(showNextSlide, 4000); // 4 секунды для смены плашки
}
document.addEventListener("DOMContentLoaded", function () {
  const cards = document.querySelectorAll(".baner__card");
  const contents = document.querySelectorAll(".baner__content");
  const links = document.querySelectorAll(".baner__card a"); // Все ссылки внутри баннеров
  if (links.length === 0) return;
  if (cards) {
    // Функция для обновления отображаемых элементов
    function updateDisplay(selectedId) {
      // Скрыть все содержимое слева и показывать только выбранный
      contents.forEach((content) => {
        if (content.id === selectedId) {
          content.style.display = "block"; // Показываем выбранный контент слева
        } else {
          content.style.display = "none"; // Остальные скрываем слева
        }
      });

      // Обновляем opacity всех baner__card
      cards.forEach((card) => {
        const cardId = card.getAttribute("data-id");
        if (cardId === selectedId) {
          card.style.display = "none"; // Скрываем выбранный баннер справа
        } else {
          card.style.display = "flex"; // Показываем остальные баннеры справа
        }
        // Добавляем opacity
        card.style.opacity = 1; // Все баннеры слева и справа делают полупрозрачными
      });
    }

    // Изначально показываем первый элемент
    updateDisplay(cards[0].getAttribute("data-id"));

    // Добавляем обработчик клика на каждый баннер
    cards.forEach((card) => {
      card.addEventListener("click", function (event) {
        event.preventDefault(); // Предотвращаем стандартное поведение (scroll)

        // Получаем ID текущего баннера
    ...
    // Обработчик для ссылок внутри baner__card
    links.forEach((link) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Получаем все секции с уникальными ID
  const sections = document.querySelectorAll(".project-wrapper__content div[id]");
  if (sections.length === 0) return;
  // Получаем все ссылки меню
  const menuLinks = document.querySelectorAll(".select__list li a");
  ...
  const options = {
    ...
    rootMargin: "0px",
    threshold: 0.6, // Процент видимости секции для срабатывания
  };
  ...
  const observer = new IntersectionObserver((entries, observer) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        // Находим соответствующую ссылку в меню
        const activeLink = document.querySelector(`.select__list li a[href="#${sectionId}"]`);

        // Удаляем все активные классы и добавляем активный только текущей ссылке
        removeActiveClasses();
        if (activeLink) {
  ...
  window.addEventListener("resize", () => {
    if (window.innerWidth <= 1020) {
      // Удаляем все active классы, если экран меньше или равен 1020px
      removeActiveClasses();
      observer.disconnect();
    } else {
      // Повторно подключаем наблюдатель при увеличении экрана
      sections.forEach((section) => {
        observer.observe(section);
      });
    }
...
document.addEventListener("DOMContentLoaded", () => {
  const items = document.querySelectorAll(".panoram__item");
  const card = document.querySelector(".panoram__card");

  if (!items.length || !card) return;

  items.forEach((item) => {
    item.addEventListener("click", () => {
      const currentTitle = card.querySelector(".panoram__card-ttl").textContent;
      const currentText = card.querySelector(".panoram__card-txt").textContent;
      const currentImageSrc = card.querySelector("img").src;

      const newTitle = item.getAttribute("data-title");
      const newText = item.getAttribute("data-text");
      const newImage = item.getAttribute("data-image");

      // Перенос данных из выбранного элемента в карточку
      card.querySelector(".panoram__card-ttl").textContent = newTitle;
      card.querySelector(".panoram__card-txt").textContent = newText;
      ...
      // Обновление текста в блоке .panoram__bx
      const panoramBx = item.querySelector(".panoram__bx");
      if (panoramBx) {
        panoramBx.innerHTML = `${currentTitle} <img class="hoverimg" src="@img/arrowhover.svg" alt="" />`;
      }

      // Перенос текущих данных карточки обратно в нажатый элемент
      item.setAttribute("data-title", currentTitle);
      item.setAttribute("data-text", currentText);
      item.setAttribute("data-image", currentImageSrc);
      item.querySelector(".panoram-img").src = currentImageSrc;

      // Анимация для активного элемента
      items.forEach((el) => el.classList.remove("active", "fade-in-item"));
      item.classList.add("active", "fade-in-item");
    });
  });
});
document.addEventListener("DOMContentLoaded", () => {
  const stroiSection = document.querySelector(".stroi");
  const stroiBox = stroiSection ? stroiSection.querySelector(".stroi__box") : null;

  if (!stroiSection || !stroiBox) {
    return;
    console.error("Секция .stroi или блок .stroi__box не найдены.");
  }

  let isBlocked = false; // Флаг блокировки
  let hasUserConfirmed = false; // Флаг, который указывает, что пользователь уже подтвердил блокировку

  // Функция для вычисления ширины скроллбара
  function getScrollbarWidth() {
    // Создаем скрытый элемент с прокруткой
    ...
    // Вычисляем разницу между полной шириной и шириной без прокрутки
  ...
  const blockScroll = () => {
    if (!isBlocked && !hasUserConfirmed) {
      isBlocked = true;

      const scrollbarWidth = getScrollbarWidth();
      document.body.style.overflow = "hidden";
      document.body.style.paddingRight = `${scrollbarWidth}px`; // Компенсируем ширину скроллбара
      document.querySelector(".back-to-top").style = `margin-right:${scrollbarWidth}px`;
      console.log("Прокрутка заблокирована.");
      // Слушаем прокрутку документа, чтобы прокручивать .stroi__box
      window.addEventListener("wheel", handleDocumentScroll, { passive: false });
    }
  };
  ...
  const unblockScroll = () => {
    if (isBlocked) {
      isBlocked = false;
      hasUserConfirmed = true; // Устанавливаем флаг, что пользователь подтвердил

      document.body.style.overflow = "";
      document.body.style.paddingRight = ""; // Убираем компенсацию
      document.querySelector(".back-to-top").marginRight = "0";

      // Удаляем слушатель для прокрутки документа
      window.removeEventListener("wheel", handleDocumentScroll);

      console.log("Прокрутка разблокирована.");
    }
  };

  // Функция для прокрутки содержимого .stroi__box
  const handleDocumentScroll = (event) => {
    if (isBlocked) {
      event.preventDefault(); // Останавливаем прокрутку документа

      // Прокручиваем .stroi__box
      stroiBox.scrollTop += event.deltaY;

      // Проверяем, достигли ли конца или начала .stroi__box
      const atBottom = stroiBox.scrollTop + stroiBox.clientHeight >= stroiBox.scrollHeight;
      const atTop = stroiBox.scrollTop <= 0;

      // Если прокрутили до конца и скроллим вниз, снимаем блокировку
      if (atBottom && event.deltaY > 0) {
        unblockScroll();
      }

      // Если прокрутили до начала и скроллим вверх, снимаем блокировку
  ...
  // Прокручиваем страницу, чтобы 90% секции оказалось в поле зрения
  const scrollToSection = () => {
    const rect = stroiSection.getBoundingClientRect();
    const windowHeight = window.innerHeight;

    // Расчет прокрутки для достижения 90% видимости
    const offset = rect.top + window.pageYOffset - windowHeight * 0.1; // Добавляем 10% сверху для компенсации
  ...
  // Проверка видимости 90% блока на экране
  const checkVisibility = () => {
    const rect = stroiSection.getBoundingClientRect();
    const windowHeight = window.innerHeight;

    // Проверяем, что 90% высоты блока находятся в пределах экрана
    const visibleHeight = Math.min(windowHeight, rect.bottom) - Math.max(0, rect.top);
    const isVisible = visibleHeight >= rect.height * 0.9;

    // Если секция видна на 90% и блокировка не активирована, прокручиваем и блокируем скролл
    if (isVisible && !isBlocked && !hasUserConfirmed) {
      scrollToSection();
      blockScroll();
    }

    // Если секция покинула 90% видимости, сбрасываем флаг подтверждения
    if (!isVisible && hasUserConfirmed) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", (event) => {
    // Проверяем, что клик был по кнопке с атрибутом data-modalV
    const button = event.target.closest("[data-modalV]");
    if (button) {
      const videoSrc = button.getAttribute("data-modalV");

      // Вставляем источник видео в модалку
    ...
    // Закрытие модалки и остановка видео при клике по крестику
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Проверка на наличие хотя бы одной карточки
  if (cards.length > 0) {
    cards.forEach((card) => {
      const topTwo = card.querySelector(".hero__card-top-two");

      // Проверка, что элемент .hero__card-top-two существует
      if (topTwo) {
        // При наведении добавляем класс
        topTwo.addEventListener("mouseover", () => {
          card.classList.add("hovered-on-top-two");
        });

        // При уходе мыши убираем класс
        topTwo.addEventListener("mouseout", () => {
          card.classList.remove("hovered-on-top-two");
        });
      } else {
        console.warn(".hero__card-top-two не найден в одной из карточек.");
      }
    });
  } else {
    console.warn(".hero__card элементы не найдены на странице.");
  }
  const projectCards = document.querySelectorAll(".projects__card");
  if (projectCards.length > 0) {
    projectCards.forEach((card) => {
      const openBtn = card.querySelector(".projects__open-btn"); // Кнопка для открытия
      const closeWrap = card.querySelector(".close-wrap-card"); // Кнопка для закрытия
      const hiddenBody = card.querySelector(".projects__card-hidden-body"); // Скрытое тело

      // Если элемент с классом .projects__open-btn существует
      if (openBtn) {
        openBtn.addEventListener("mouseenter", () => {
          hiddenBody.style.opacity = "1";
          hiddenBody.style.right = "0"; // Показываем скрытое тело
        });
      }

      // Если элемент с классом .close-wrap-card существует
      if (closeWrap) {
        closeWrap.addEventListener("click", () => {
          hiddenBody.style.opacity = "0"; // Скрываем
          hiddenBody.style.right = "-100%"; // Скрываем
        });
      }

      // При уходе мыши с карточки скрываем тело
      card.addEventListener("mouseleave", () => {
        hiddenBody.style.opacity = "0"; // Возвращаем в исходное состояние
        hiddenBody.style.right = "-100%"; // Скрываем
      });
    });
  }
...
// Получаем элементы
const dataElements = document.querySelectorAll("[data-fulll]");
const modal = document.querySelector(".modal-full-slider");
const closeModalBtn = modal?.querySelector(".modal-full-slider__close");
const swiperSlides = modal?.querySelectorAll(".modal-full-slider__slide");
const nextBtn = modal?.querySelector(".btn-next-modall");

let currentSlideIndex = 0; // Индекс текущего слайда

// Функция для нахождения активного слайда
function getActiveSlideIndex() {
  if (!swiperSlides) return 0;
  return Array.from(swiperSlides).findIndex((slide) => slide.classList.contains("swiper-slide-active"));
}

// Функция кликов по кнопке переключения для достижения нужного слайда
function goToSlide(targetIndex) {
  if (!nextBtn || !swiperSlides) return;
  ...
  let clicksNeeded = targetIndex - activeIndex;
  if (clicksNeeded < 0) {
    clicksNeeded += totalSlides; // Учитываем rewind (цикл слайдера)
  }
...
function openModal(index) {
  ...
  modal.classList.add("open"); // Добавляем класс для показа модалки
  goToSlide(index); // Переходим к нужному слайду
}

// Функция закрытия модального окна
function closeModal() {
  if (!modal) return;
  modal.classList.remove("open"); // Убираем класс для скрытия модалки
}

// Добавляем обработчики событий на элементы с data-атрибутом
if (dataElements) {
  dataElements.forEach((element, index) => {
    element.addEventListener("click", () => {
      openModal(index); // Передаем индекс элемента
    });
  });
}
...
// Дополнительно: закрытие модалки при клике вне её содержимого
